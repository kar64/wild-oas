...
function BookingRow({
  ...
  const {isLoading:isDeleteBooking,mutate:deleteBooking}=useDeleteCabin()
    ...
    <Table.Row>
      ...
      <Modal>
        ...
        <Modal.Window name='delete'>
          <ConfirmDelete disabled={isDeleteBooking} resourceName='booking' onConfirm={()=>{deleteBooking(bookingId)}}/>
        </Modal.Window>
      </Modal>
    </Table.Row>
  );
